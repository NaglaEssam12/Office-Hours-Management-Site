 ...
 * @author ME
 */
@WebServlet(name = "ViewStaffMemberMessages", urlPatterns = {"/ViewStaffMemberMessages"})
public class ViewStaffMemberMessages extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            response.sendRedirect("staff_member_reply_message.jsp");
